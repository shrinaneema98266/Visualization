...
st.set_page_config(
    page_title="Automatic Generation of Visualizations and Infographics",
    page_icon="📊",
)
...
# Display a masked version of the API key to confirm it's loaded
display_key = openai_key[:2] + "*" * (len(openai_key) - 5) + openai_key[-3:]
st.sidebar.write(f"OpenAI API key loaded: {display_key}")
